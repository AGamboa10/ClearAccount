...
{
    public partial class PrincipalDstk : Form
    {
        public PrincipalDstk()
        {
            InitializeComponent();
        }
        ...
        //Capturar posicion y tamaño del formulario antes de maximizar para restaurar
        int lx, ly;
        int sw, sh;
        ...
        {
            AbrirFormulario<formCrearUsuario>();
        ...
        private void BtnAgregaNota_Click(object sender, EventArgs e)
        {
            AbrirFormulario<formAgregarNota>();
        }
